...
def get_admin_panel_keyboard(i18n_instance, lang: str,
    ...
    builder.button(text=_button("admin_stats_and_monitoring_section"),
                   callback_data="admin_section:stats_monitoring")
    
    # Управление пользователями  
    builder.button(text=_button("admin_user_management_section"),
                   callback_data="admin_section:user_management")
    
    # Промокоды и маркетинг
    builder.button(text=_button("admin_promo_marketing_section"),
                   callback_data="admin_section:promo_marketing")
    
    # Реклама
    builder.button(text=_button("admin_ads_section"),
                   callback_data="admin_action:ads")

    # Системные функции
    builder.button(text=_button("admin_system_functions_section"),
...
def get_stats_monitoring_keyboard(i18n_instance, lang: str) -> InlineKeyboardMarkup:
    ...
    builder.button(text=_button("admin_stats"),
                   callback_data="admin_action:stats")
    builder.button(text=_button("admin_view_payments"),
                   callback_data="admin_action:view_payments")
    builder.button(text=_button("admin_view_logs_menu"),
                   callback_data="admin_action:view_logs_menu")
    
    builder.button(text=_button("back_to_admin_panel"),
...
def get_user_management_keyboard(i18n_instance, lang: str) -> InlineKeyboardMarkup:
    ...
    builder.button(text=_button("admin_users_management"),
                   callback_data="admin_action:users_list:0")
    builder.button(text=_button("admin_users_search"),
                   callback_data="admin_action:users_search_prompt")
    builder.button(text=_button("admin_ban_management_section"),
...
def get_ban_management_keyboard(i18n_instance, lang: str) -> InlineKeyboardMarkup:
    ...
    builder.button(text=_button("admin_ban_user"),
                   callback_data="admin_action:ban_user_prompt")
    builder.button(text=_button("admin_unban_user"),
                   callback_data="admin_action:unban_user_prompt")
    builder.button(text=_button("admin_view_banned_users"),
                   callback_data="admin_action:view_banned:0")
    
    builder.button(text=_button("back_to_user_management"),
                   callback_data="admin_section:user_management")
    builder.adjust(2, 1, 1)
    return builder.as_markup()
...
def get_promo_marketing_keyboard(i18n_instance, lang: str) -> InlineKeyboardMarkup:
    ...
    builder.button(text=_button("admin_create_promo"),
                   callback_data="admin_action:create_promo")
    builder.button(text=_button("admin_create_bulk_promo"),
                   callback_data="admin_action:create_bulk_promo")
    builder.button(text=_button("admin_promo_management"),
...
def get_system_functions_keyboard(i18n_instance, lang: str) -> InlineKeyboardMarkup:
    ...
    builder.button(text=_button("admin_broadcast"),
                   callback_data="admin_action:broadcast")
    builder.button(text=_button("admin_sync_panel"),
                   callback_data="admin_action:sync_panel")
    builder.button(text=_button("admin_queue_status"),
...
def get_ads_menu_keyboard(i18n_instance, lang: str) -> InlineKeyboardMarkup:
    _button = lambda button_id, **kwargs: get_button_text(button_id, i18n_instance, lang, **kwargs)
    builder = InlineKeyboardBuilder()
    builder.button(text=_button("admin_ads_create"),
...
def get_ad_card_keyboard(i18n_instance, lang: str, campaign_id: int, back_page: int) -> InlineKeyboardMarkup:
    ...
    builder.button(text=_button("admin_ads_delete"),
                   callback_data=f"admin_ads:delete:{campaign_id}:{back_page}")
    builder.button(text=_button("back_to_ads_list"),
...
def get_logs_menu_keyboard(i18n_instance, lang: str) -> InlineKeyboardMarkup:
    _button = lambda button_id, **kwargs: get_button_text(button_id, i18n_instance, lang, **kwargs)
    builder = InlineKeyboardBuilder()
    builder.button(text=_button("admin_view_all_logs"),
                   callback_data="admin_logs:view_all:0")
    builder.button(text=_button("admin_view_user_logs_prompt"),
                   callback_data="admin_logs:prompt_user")
    builder.button(text=_button("admin_export_logs_csv"),
                   callback_data="admin_logs:export_csv")
    builder.row(
        InlineKeyboardButton(text=_button("back_to_admin_panel"),
                             callback_data="admin_action:main"))
    builder.adjust(2, 1, 1)
    return builder.as_markup()
...
def get_logs_pagination_keyboard(
    ...
    if back_to_logs_menu:
        builder.row(
            InlineKeyboardButton(text=_button("admin_logs_menu_title"),
                                 callback_data="admin_action:view_logs_menu"))
    else:
        builder.row(
            InlineKeyboardButton(text=_button("back_to_admin_panel"),
...
def get_banned_users_keyboard(banned_users: List[User], current_page: int,
    ...
    for user_row in banned_users:
        ...
        button_text = _button("admin_banned_user_button_text",
...
def get_users_list_keyboard(users: List[User], current_page: int,
    ...
    builder.row(
        InlineKeyboardButton(
            text=_button("back_to_user_management"),
            callback_data="admin_section:user_management"
        )
    )
...
def get_user_card_keyboard(user_id: int,
    ...
    if is_banned:
        builder.button(
            text=_button("user_card_unban"),
            callback_data=f"admin_unban_confirm:{user_id}:{banned_list_page}")
    else:
        builder.button(
            text=_button("user_card_ban"),
            callback_data=f"admin_ban_confirm:{user_id}:{banned_list_page}")
    builder.button(
        text=_button("user_card_open_profile"),
        url=f"tg://user?id={user_id}"
    )
    builder.button(
        text=_button("user_card_back_to_banned_list"),
...
def get_confirmation_keyboard(yes_callback_data: str, no_callback_data: str,
    ...
    _button = lambda button_id, **kwargs: get_button_text(button_id, i18n_instance, lang, **kwargs)
    builder = InlineKeyboardBuilder()
    builder.button(text=_button("yes"), callback_data=yes_callback_data)
    builder.button(text=_button("no"), callback_data=no_callback_data)
    return builder.as_markup()
...
def get_broadcast_confirmation_keyboard(lang: str,
    ...
    target_all_label = _button("broadcast_target_all")
    target_active_label = _button("broadcast_target_active")
    target_inactive_label = _button("broadcast_target_inactive")
    ...
    # Row: confirmation
    builder.button(text=_button("confirm_broadcast_send"),
                   callback_data="broadcast_final_action:send")
    builder.button(text=_button("cancel_broadcast"),
